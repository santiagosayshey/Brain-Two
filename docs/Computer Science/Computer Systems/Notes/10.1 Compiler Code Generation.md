...
- Jack syntax can distinguish between these identifiers; no need for “linking” or adding to the symbol table.
...
- **Compilation Examples**:
  ...
  - The `Math` class is part of the OS (note is cut off here).