...
```
You are asked to add INVOICE entities to your model, where the PURCHASE_ORDER relationship is a terminary relationship between PROJECT, SUPPLIER and INVOICE. Every invoice must be associated with the supplier but a given project may have 0, 1,  or many invoices 
