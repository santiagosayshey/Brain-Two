...
```
We define value neutrals being impartial and unbiased in terms of the technology. It means that the technology is not intrinusically unethical or immoral. It's just that it can be put to that usage Your design software that uses chat .... and then build up a body of evidence
```