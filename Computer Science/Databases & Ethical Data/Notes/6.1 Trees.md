...
- If you look from bottom to top, the node that comes top left comes next, and if there are none, go back to the first root where there was something on the right