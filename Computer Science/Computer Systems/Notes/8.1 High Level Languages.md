...
- `field` variables - defined at class level and represent object properties
- `local` variables - defined at and used within subroutines
- `parameter` variables represent arguments passed into subroutines
	- `local, parameter` are created before subroutine starts executing and recycled once finished
