...
- This is essentially achieved using the `goto <function>` command to jump between stack frames (wormholes!)
	- Achieved by creating a symbolic label in assembly code that marks where a function starts