...
![](Images/figure_wo_caption_8.1.png)
...
### Design
- We can add more functionality to the three modules implemented in the previous chapter - `parser, codewriter and VM Translator`
- 