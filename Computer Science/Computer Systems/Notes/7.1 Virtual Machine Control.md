...
```
Side Note: This chapter has been incredibly therapuetic for me to read. The idea that some insane logical expression can be abstracted down to a single value is entirely fascinating and completely eye opening for me. I struggle with anxiety and jumping to conclusions
```