...
// Increment the SP to make room for the new value. The SP always points to the next available address in the stack. By incrementing, we ensure we don't overwrite the current top value.
