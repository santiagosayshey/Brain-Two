...
```
@sp             // get address of stack pointer
AM = M-1        // decrement the stack pointer by 1 (since we are removing from the stack)
D=M             // store the value of the top of the stack inside D register (temporarily)
@Bob.7          // get address of 7th value in bob
M=D             // s
```
### VM Emulator
