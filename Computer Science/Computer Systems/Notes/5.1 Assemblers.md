...
#### Initialisation
- Create an empty symbol table and put any predefined symbols in there

#### First Pass
- Go through line by line and add all user defined symbols to symbol table
- A label's value is the location of the first instruction after the label
