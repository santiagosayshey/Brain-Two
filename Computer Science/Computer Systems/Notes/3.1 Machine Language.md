...
- Any sequence of letters, digits, underscores, dots, dollar signs and colons that doesnt begin witha a digit
...
- Composed of text lines, each being an A or C instruction or a label declaration or comment
